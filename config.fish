...
alias gl 'git pull'
alias glc './get-last-commit-url.py | pbcopy'
alias glco './get-last-commit-url.py | xargs open'
alias gp 'git push; ./get-last-commit-url.py | pbcopy'
...
alias pp "pbpaste|snipt post_and_get_url -t|pbcopy;"
